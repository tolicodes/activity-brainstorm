...
import Modal from './Admin/DataGrid/Editors/Modal';
...
export const EVENT = {
  ...
  fields: [
    ...
    {
      key: 'properties', name: 'Properties', formatter: Modal, editor: Modal, editable: true, required: true, editorProps: {
        fields: [
...
export const ACTIVITIES = {
  ...
  fields: [
    ...
    {
      key: "properties", name: "Properties", formatter: Modal, editor: Modal, editable: true, editorProps: {
        fields: [
          { key: "properties", subKey: "onBeach", name: "On the Beach", editor: Checkbox, formatter: Checkbox },
          { key: "properties", subKey: "covidFriendly", name: "COVID Friendly", formatter: Checkbox, editor: Checkbox, editable: true },
          { key: "properties", subKey: "openNow", name: "Open Now", formatter: Checkbox, editor: Checkbox, editable: true },
          {
            key: "properties", subKey: "location", name: "Location", formatter: GooglePlacesAutocomplete, editor: GooglePlacesAutocompleteEditor, editable: true, editorProps: {
